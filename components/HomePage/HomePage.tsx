...
const HomePage = () => {
  ...
  return (
    <div className={styles.root}>
      ...
      <Checkbox title="Можно с питомцами" name="box1" isChecked onChange={(name, checked) => { console.log('checked', name, checked); }} />
      <Checkbox title="Широкий коридор" name="box2" isBoldTitle description="Ширина коридоров в номере не менее 91 см." onChange={(name, checked) => { console.log('checked2', name, checked); }} />
